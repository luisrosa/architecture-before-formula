...
\begin{proof}
Because $v_1=v_2=v$ and both coefficient rows have unit mass,
\[
\sum_i\alpha_iv_i=(\alpha_1+\alpha_2)v=v
\]
and likewise $\sum_i\alpha_i'v_i=v$, while the displayed coefficient rows are distinct.
\end{proof}
