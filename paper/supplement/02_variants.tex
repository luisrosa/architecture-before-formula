...
A mask can have different provenance:
\begin{itemize}
...
\item state-generated, as in hard dynamic routing.
\end{itemize}
The attention normal form permits any declared mask with nonempty rows. The provenance profile distinguishes the corresponding schemas even when two masks agree on a selected state window.
